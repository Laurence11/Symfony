...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'OC\\CoreBundle\\Controller\\AcceuilController::indexAction',  '_route' => 'oc_core_homepage',);
        }

        // oc_core_contact
        if ($pathinfo === '/Contact') {
            return array (  '_controller' => 'OC\\CoreBundle\\Controller\\ContactController::contactAction',  '_route' => 'oc_core_contact',);
        }
